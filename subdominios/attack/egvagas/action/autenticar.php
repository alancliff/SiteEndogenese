                ...
                while ($valor = $sql->fetch(PDO::FETCH_ASSOC) )
                    {
                       ...
                       {
                        echo "<script language='javascript' type='text/javascript'>alert('Login e/ou senha incorretos');window.location.href='/egvagas/admin/login.php';</script>";
                         die();
                       }

                    }
                    header("location: /egvagas/admin/index.php");
            }
      echo "<script language='javascript' type='text/javascript'>alert('Login e/ou senha incorretos');window.location.href='/egvagas/admin/login.php';</script>";
