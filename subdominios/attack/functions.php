	...
	if ( ! function_exists( 'redwaves_copyrights' ) ) {
		...
		<div id="copyright-note">
			...
			<div style="text-align: center;float:left;">
				...
				<span>Desenvolvido por <a href="http://www.endogenese.com.br/" rel="generator" class="fonte_endogenese">Endogênese Soluções</a></span><span class="img_logo_endogenese"><a href="http://www.endogenese.com.br/" rel="generator"><img src="/wp-content/themes/redwaves-lite/images/logo_endogenese.png" ></a></span>

			</div>
			</div> <!--.site-info -->
			<div class="right" style="text-align: center">

				<span class="fonte_attack animacao_attack">Attack Jiu Jitsu Team</span><br>
